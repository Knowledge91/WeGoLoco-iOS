...
public class APIWeGoLocoClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "APIWeGoLocoClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:APIWeGoLocoClient = {
        ...
        return APIWeGoLocoClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = APIWeGoLocoClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `APIWeGoLocoClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> APIWeGoLocoClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         APIWeGoLocoClient.registerClient(withConfiguration: configuration, forKey: "USWest2APIWeGoLocoClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = APIWeGoLocoClient.client(forKey: "USWest2APIWeGoLocoClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(APIWeGoLocoClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> APIWeGoLocoClient {
		objc_sync_enter(self)
		if let client: APIWeGoLocoClient = _serviceClients.object(forKey: key) as? APIWeGoLocoClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			APIWeGoLocoClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! APIWeGoLocoClient;
	}
    ...
    /*
     ...
     return type: APIResponseSchema
     */
    public func tinponsPost(body: APIRequestSchema) -> AWSTask<APIResponseSchema> {
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/tinpons", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: body, responseClass: APIResponseSchema.self) as! AWSTask<APIResponseSchema>
	}
